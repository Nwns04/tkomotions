...
function SchoolWhatsAppCTA() {
  const phone = schoolInfo.whatsapp.replace(/[^0-9]/g, '');
  const message = encodeURIComponent(`Hello ${schoolInfo.name}, I would like to make an admissions enquiry.`);
...
export default SchoolWhatsAppCTA;
