  ...
  return (
    <>
      ...
      <div className="bg-ink text-white border-b border-white/10">
        <div className="container-hotel px-4 md:px-6 lg:px-8 py-2.5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs">
          <span><strong>TKO Motions school website demo</strong> — sample content, adaptable to your school.</span>
          <Link to="/school/contact" className="text-gold font-semibold hover:text-white transition-colors">Request a website like this →</Link>
        </div>
      </div>
      <SchoolHeroCarousel />
      ...
      <section className="section-padding-school bg-cream relative overflow-hidden">
        ...
        <div className="container-hotel px-4 md:px-6 lg:px-8 text-center max-w-3xl mx-auto relative">
          ...
          <p className="text-deep-green text-sm font-semibold tracking-[0.25em] uppercase mb-3">Welcome to Crestfield Academy</p>
          <h2 className="text-4xl font-serif font-bold text-ink mb-6">A School That Feels Like Home</h2>
          <p className="text-slate leading-relaxed mb-4">
            Crestfield Academy is a fictional demonstration school created to show how a modern school website can present learning, admissions, facilities, activities, and parent communication clearly.
          </p>
          <p className="text-slate leading-relaxed mb-10">
            The final website would be tailored to the school’s real curriculum, age groups, values, location, photos, admissions process, and communication needs.
          </p>
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-ink/90">
          <div className="bg-white rounded-lg overflow-hidden max-w-3xl w-full">
            <div className="flex items-center justify-between p-4 border-b border-slate/20">
              <h3 className="font-serif font-bold text-ink">School Story Preview</h3>
            ...
            <div className="aspect-video bg-ink flex items-center justify-center">
              <div className="text-center text-white p-8">
                ...
                <p className="text-lg font-serif">School Video / Campus Story</p>
                <p className="text-sm text-white/60">A live school project can use this space for a campus film, principal welcome, or student-life reel.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-hotel px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: schoolInfo.stats.educators, suffix: '+', label: 'Educators' },
              { value: schoolInfo.stats.clubs, suffix: '+', label: 'Clubs & Activities' },
              { value: schoolInfo.stats.yearsOfExcellence, suffix: '+', label: 'Years of Growth' },
            ].map(stat => (
              <div key={stat.label}>
      ...
      <section className="bg-oak-green py-16">
        <div className="container-hotel px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 mb-8">Admissions for the 2026/2027 academic session are now open.</p>
