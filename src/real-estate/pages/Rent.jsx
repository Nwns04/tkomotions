...
function Rent() {
  ...
  const rentFilters = { ...filters, status: 'for-rent' };
  const filteredProperties = usePropertyFilters(rentFilters, sortBy);

  return (
    <>
      <div className="bg-light-gray py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-navy">Properties for Rent in Abuja</h1>
