...
function Buy() {
  ...
  const buyFilters = { ...filters, status: 'for-sale' };
  const filteredProperties = usePropertyFilters(buyFilters, sortBy);

  return (
    <>
      <div className="bg-light-gray py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-navy">Properties for Sale in Abuja</h1>
